...
export function Store (dispatcher, state, actions) {
  function NewStore () { this.constructor = NewStore }
  NewStore.__super__ = Store
  NewStore.prototype = { ...Store.prototype }
  const instance = new NewStore()
...
Store.prototype = {
  ...
  initialize (dispatcher, state, actions) {
